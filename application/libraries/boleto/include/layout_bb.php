...
#instr_header {
	background: url('<?php echo base_url('assets/boleto');?>/imagens/logo_empresa.png') no-repeat top left;
	padding-left: 160px;
	height: 65px;
}
...
do Sacado</b></div></TD></tr></tbody></table>
		...
		<tbody>
		<tr>
			<td width=150><IMG SRC="<?php echo base_url('assets/boleto');?>/imagens/logobb.jpg"></td>
			<td width=50>
